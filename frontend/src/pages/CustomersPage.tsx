...
import {ImportSummary,type ImportErgebnis} from '../components/ImportSummary'
...
export function CustomersPage(){
  ...
  async function importCsv(event:React.ChangeEvent<HTMLInputElement>){
    ...
    try{
      ...
      // Die Gründe gehören auf den Bildschirm, nicht in die Konsole: wer
      // 40 übersprungene Zeilen sieht, muss erfahren können, warum.
      setImportErgebnis({
        angelegt:ergebnis.created,
        uebersprungen:ergebnis.skipped,
        hinweise:ergebnis.notes,
        einheit:'Kunden',
      })
    }catch(err){
