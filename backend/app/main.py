...
from app.routers import admin, appointments, assistant, auth, buntewoche, customers, dashboard, directory, feedback, followups, history, invoices, messages, notifications, offers, pipeline, presentations, products, profile, rentals, reports, sales, search, sysadmin, team, tradeins
...
for router in [auth.router,admin.router,dashboard.router,customers.router,appointments.router,sales.router,invoices.router,offers.router,pipeline.router,presentations.router,products.router,rentals.router,buntewoche.router,messages.router,assistant.router,search.router,history.router,team.router,profile.router,directory.router,notifications.router,followups.router,tradeins.router,reports.router,sysadmin.router,feedback.router]:
